...
def run_test_count_positive_sines():
    ...
    # ------------------------------------------------------------------
    # TDONE: 6. Implement this TEST function.
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([1, 2, 3, 4])
    print()
    ...
    # Test 12:
    expected = 1
    actual = count_positive_sines([0, -1, 1])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 190
    actual = sum_first_n([100, -10, 50, 50], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 0
    actual = sum_first_n([50, 0, -50, 5], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
